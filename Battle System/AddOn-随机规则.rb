#=============================================================================
# ■ Add-On 随机规则  by 老鹰（http://oneeyedeagle.lofter.com/）
...
#        已经加入了默认的八维属性 mhp, mmp, atk, def, mat, mdf, agi, luk
...
#
# - 设置扩展规则
#       <exr ex-sym prob {value_s}> → 添加一个概率因子prob的扩展规则
