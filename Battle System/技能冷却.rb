...
# 【注意】
#
# 1. 以上设置的技能冷却，只会在战斗中角色主动使用技能后生效，
#    菜单中、强制战斗行动、额外战斗行动等都不会生效
#
# 2. 在战斗中，角色每次回合结束时，全部技能的冷却CD - 1
#    但注意，由于当前回合使用的技能，设置冷却时间是在回合结束前，
#      所以冷却时间会自动+1，再跟着回合结束减去1
#
# 3. 在战斗结束时将会清空全部技能的CD，
#    因此可以在战斗开始前，利用下述脚本预设指定技能的提前CD
#
#-----------------------------------------------------------------------------
# 【高级】
#
