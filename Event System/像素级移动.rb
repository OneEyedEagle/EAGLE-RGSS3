...
#==============================================================================
$imported ||= {}
$imported["EAGLE-PixelMove"] = "1.3.1"
#=============================================================================
# - 2022.2.14.22 修复碰撞矩形设置无效的bug
#=============================================================================
...
#        即从矩形左上角开始，朝右侧和下侧各移动 16 像素后，到达碰撞矩形的右下角
#
# - 可以重复填写，后写的将覆盖之前的设置
...
#              d 为 2/4/6/8 代表四方向
#
# - 为了防止出现二义性，当玩家位于该事件上时（玩家的坐标处于该事件的碰撞矩形内），
...
#==============================================================================
  ...
  #   若想要事件的碰撞矩形依旧为原始一格大小，则设置为 (-8, -24, 32, 32)
  #
  #--------------------------------------------------------------------------
  # ● 【设置】玩家的初始碰撞矩形（单位：像素）
  #  请确保各个数字均为 PIXEL_PER_UNIT 的整数倍
...
class Game_CharacterBase
  ...
  #--------------------------------------------------------------------------
  # ○ 获取碰撞矩形（移动单位）
  #  当 raw_rect 为 true 时，返回角色在自身坐标下的碰撞矩形
