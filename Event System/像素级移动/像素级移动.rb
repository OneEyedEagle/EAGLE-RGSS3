...
#==============================================================================
$imported ||= {}
$imported["EAGLE-PixelMove"] = "1.4.0"
#=============================================================================
# - 2022.3.1.21 修改与原始格子大小一致时的rect设置；修复图块事件无效的bug
#=============================================================================
...
#==============================================================================
  ...
  #--------------------------------------------------------------------------
  EVENT_RECT = Rect.new(-8, -16, 20, 16)
  #
  ...
  #   在事件开头备注里则写成 <rect x=-12 y=-24 w=32 h=32>
  ...
  #  请确保各个数字均为 PIXEL_PER_UNIT 的整数倍
  #--------------------------------------------------------------------------
  PLAYER_RECT = Rect.new(-8, -16, 16, 16)
  #--------------------------------------------------------------------------
  # ● 【设置】玩家每次按键移动的移动单位数
  #--------------------------------------------------------------------------
  PLAYER_MOVE_UNIT = 4
