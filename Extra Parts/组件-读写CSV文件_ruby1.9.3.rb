...
# ----------------------------------------------------------------------------
# 老鹰注：
#   相比于 Ruby 1.9.3 中的原版，为了能放入RGSS3中使用，
#   删去了 datetime 库的相关内容，即无法识别 CSV 中的日期及时间。
# ----------------------------------------------------------------------------
...
#                  },
  ...
  #
  def raw_encoding(default = Encoding::UTF_8) #Encoding::ASCII_8BIT)
