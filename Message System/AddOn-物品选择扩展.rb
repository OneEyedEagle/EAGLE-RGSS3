...
module MESSAGE_EX
  ...
  # ● 获取指定转义符的基础设置
  #--------------------------------------------------------------------------
  class << self; alias eagle_keyitem_ex_get_default_params get_default_params; end
  def self.get_default_params(param_sym)
    return KEYITEM_PARAMS_INIT if param_sym == :keyitem
    eagle_keyitem_ex_get_default_params(param_sym)
  end
  #--------------------------------------------------------------------------
  # ● 获取选择物品的种类数组
  #--------------------------------------------------------------------------
