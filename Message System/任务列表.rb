#==============================================================================
# ■ 任务列表 by 老鹰（http://oneeyedeagle.lofter.com/）
# ※ 本插件需要放置在【组件-位图绘制转义符文本 by老鹰】之下
#==============================================================================
$imported ||= {}
$imported["EAGLE-QuestList"] = true
#==============================================================================
# - 2021.9.10.10
#==============================================================================
# - 本插件新增了简易的文字版任务列表UI
...
#
# - 本插件汲取【词条系统（文字版） by老鹰】的设计模式，编写了一套简洁的任务列表。
#
# - 但注意，本插件只有显示的作用，并没有和其他系统的交互（比如战斗），
#    请自己手动编写、设计任务的领取、完成等。
#
#---------------------------------------------------------------------------
# 【任务新增：事件指令-注释】
...
DATA["任务名称"] = {  # 需要保证唯一性
  :info => "任务内容文本",  # 详情页中所显示的任务内容文本，可以用转义符，用\n换行
  #:title => "任务标题",  # 可以省略，省略时与"任务名称"一致
  #:tag => "",   # 利用 UI_LIST_INFO_LEFT 常量新增的详情页左侧项，可以省略
}
...
# 【呼叫UI】
#
# - 利用全局脚本 QUEST.start_list 来呼叫本插件编写的简易UI
#   同样可以在事件脚本中调用，将立即暂停其他内容，优先处理UI
#
#===============================================================================

# TODO
#  任务板（打开可接取任务的清单窗口，按确定键查看任务详细说明）
#  任务提示（当前主线任务的提示）
