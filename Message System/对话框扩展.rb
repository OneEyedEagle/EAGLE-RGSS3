...
#        此时只有在事件脚本中调用 $game_message.eagle_message = true 时，
#         本对话框才代替默认对话框生效；
#         而调用 $game_message.eagle_message = false 即可切回默认对话框
#     若此常量被设为 false，则本对话框将完全替代默认对话框
# - 该兼容模式是为了确保在不影响对话框的基础上，使用 AddOn-并行对话 等功能
# - 由于对话框存在动态的开启关闭特效，若对话框切换后，旧的对话框仍然冻结在地图上，
#   请在对话框切换的事件脚本前后添加【等待10帧】，来保证旧对话框顺利完成打开/关闭
#----------------------------------------------------------------------------
