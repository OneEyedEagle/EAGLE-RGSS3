...
#==============================================================================
$imported ||= {}
$imported["EAGLE-MessagePara"] = "1.1.0"
#==============================================================================
# - 2022.9.5.23 随对话框更新
#==============================================================================
# - 本插件利用【对话框扩展】中的工具生成并行显示的对话
#--------------------------------------------------------------------------
# ○ 概念：标签序列
#--------------------------------------------------------------------------
# - 默认的事件页类似，但为了能方便使用脚本进行编写，故引入了该结构。
#   具体的，由指定的标签/标签对进行任意排列而组成的字符串，并将按顺序逐个解析执行。
#
# - 注意：
#    ·在实际解析前，将应用 $game_message 的全部转义符参数作为并行对话框的初始值
#    ·下述所有标签均大小写敏感，在默认情况下，使用小写字母
#
# - 可用标签一览：
#
#    <msg>...</msg>
...
#       示例： <face actor1 0>
#                → 之后的对话框将显示 actor1 脸图文件中的第 1 个脸图（左上角的）
#
#    <msgp param_str>
#       → 设置之后的对话框的相关参数
