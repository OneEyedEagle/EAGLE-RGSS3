#==============================================================================
# ■ 快捷功能界面 by 老鹰（https://github.com/OneEyedEagle/EAGLE-RGSS3）
#==============================================================================
$imported ||= {}
$imported["EAGLE-EventToolbar"] = "1.1.0"
#==============================================================================
# - 2024.2.3.13 兼容鼠标
#==============================================================================
...
module TOOLBAR
  ...
  def self.init_window_command
    ...
    if $imported["EAGLE-Dictionary"]
      ...
      @window_toolbar.set_handler(:dict, DICT.method(:start))
    end
    ...
    if $imported["EAGLE-QuestList"]
      ...
      @window_toolbar.set_handler(:quest, QUEST.method(:start_list))
    end
  ...
  def self.set_window_toolbar
    @window_toolbar.x = WIN_COMMAND_X
