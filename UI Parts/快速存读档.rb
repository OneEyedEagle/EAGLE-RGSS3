#==============================================================================
# ■ 快速存读档 by 老鹰（https://github.com/OneEyedEagle/EAGLE-RGSS3）
#==============================================================================
$imported ||= {}
$imported["EAGLE-FastSL"] = "1.1.5"
#==============================================================================
# - 2025.7.31.0 
#==============================================================================
...
#     在本插件中，若读档后为文本框或选择框，则将溯回至其相邻的上一个对话框并显示。
#
#------------------------------------------------------------------------------
# - 高级：
#
...
class Game_Interpreter
  ...
  def after_marshal_load
    ...
    # 特殊的，如果当前是文本框或选择框，检查上一个指令是否为对话
    if @index - 1 > 0 && (@list[@index].code == 102 || @list[@index].code == 401)
      while true
