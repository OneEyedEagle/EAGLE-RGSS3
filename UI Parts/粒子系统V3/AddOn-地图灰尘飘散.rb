#==============================================================================
# ■ Add-On 地图灰尘飘散 by 老鹰（https://github.com/OneEyedEagle/EAGLE-RGSS3）
# ※ 本插件需要放置在【粒子模板-发射类 by老鹰】之下
#==============================================================================
$imported ||= {}
$imported["EAGLE-Particle-MapDust"] = "3.0.1"
#==============================================================================
# - 2026.2.23.23 适配 粒子系统 3.0.0版本
#==============================================================================
...
class PT_Emitter_DustOnMap < PT_Emitter
  def init_others
    super
...
class Spriteset_Map
  ...
  # ● 生成人物精灵
  #--------------------------------------------------------------------------
  alias eagle_particle_mapdust_create_characters create_characters
  def create_characters
    finish_dusts
    eagle_particle_mapdust_create_characters
    create_dusts
    start_dusts
  end
  #--------------------------------------------------------------------------
  # ● 释放人物精灵
  #--------------------------------------------------------------------------
  alias eagle_particle_mapdust_dispose_characters dispose_characters
  def dispose_characters
    finish_dusts
    eagle_particle_mapdust_dispose_characters
  end
